      ...
      >
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 my-auto py-6 sm:py-10 lg:py-12">
          <div className="max-w-4xl text-center md:text-left">
            ...
            <p className="gt-reveal text-brand-cream/80 text-xs sm:text-base lg:text-xl font-sans font-light leading-relaxed max-w-2xl mb-6 sm:mb-10 mx-auto md:mx-0">
