...
export default function AboutPage() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
        ...
        if (pillarsText) {
          ...
          gsap.fromTo(pillarsTitleElements,
            { y: 30, opacity: 0 },
            {
              ...
              scrollTrigger: { trigger: pillarsText, start: "top 80%", toggleActions: "play none none none" }
            }
          );
        }
        if (pillarsGrid) {
          ...
          gsap.fromTo(cards,
            { y: 50, opacity: 0 },
            {
              ...
              scrollTrigger: { trigger: pillarsGrid, start: "top 75%", toggleActions: "play none none none" }
            }
          );
        }
      }
        ...
        if (timelineLine) {
          gsap.fromTo(timelineLine,
            { scaleX: 0 },
            {
              ...
              scrollTrigger: { trigger: timelineSection, start: "top 70%", toggleActions: "play none none none" }
            }
          );
        }
        if (timelineGrid) {
          ...
          gsap.fromTo(items,
            ...
            {
              y: 0, opacity: 1, duration: 1.2, ease: "power4.out", stagger: 0.2,
              scrollTrigger: { trigger: timelineGrid, start: "top 75%", toggleActions: "play none none none" }
            }
          );
        }
      }
      ...
      if (storySection && storyImageWrapper && storyImageParallax && storyImage && storyText) {
        ...
        gsap.timeline({
          scrollTrigger: { trigger: storySection, start: "top 75%", toggleActions: "play none none none" }
        })
        .to(storyImageWrapper, { clipPath: "inset(0% 0% 0% 0%)", duration: 1.8, ease: "power4.inOut" })
        .to(storyImage, { scale: 1.0, duration: 2.2, ease: "power4.out" }, "-=1.6")
        ...
        gsap.fromTo(storyImageParallax,
          { yPercent: -8 },
          {
            ...
            scrollTrigger: { trigger: storyImageWrapper, start: "top bottom", end: "bottom top", scrub: 0.3 }
          }
        );
      }
      ...
      if (teamSection) {
        if (teamTitle) {
          ...
          gsap.fromTo(titleElements,
            ...
            {
              y: 0, opacity: 1, duration: 1.2, ease: "power4.out", stagger: 0.15,
              scrollTrigger: { trigger: teamTitle, start: "top 80%", toggleActions: "play none none none" }
            }
          );
        }
        if (teamGrid) {
          ...
          gsap.fromTo(members,
            ...
            {
              y: 0, opacity: 1, duration: 1.2, ease: "power4.out", stagger: 0.2,
              scrollTrigger: { trigger: teamGrid, start: "top 75%", toggleActions: "play none none none" }
            }
          );
        }
      }
  ...
  return (
    <div className="bg-brand-cream min-h-screen flex flex-col selection:bg-brand-gold selection:text-brand-black">
      ...
      {/* ── Hero Banner ── */}
      <section ref={heroSectionRef} className="relative pt-20 pb-10 md:pt-24 md:pb-14 border-b border-brand-gold/15 overflow-hidden">
        <Image
          ref={heroImageRef}
      ...
      <section ref={pillarsSectionRef} className="py-10 sm:py-14 lg:py-16 bg-brand-cream border-t border-brand-gold/15">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 xl:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            {/* Left sticky label */}
            <div ref={pillarsTextRef} className="lg:col-span-4 flex flex-col justify-start lg:sticky lg:top-24 h-fit">
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row gap-4 sm:gap-5 items-start">
                      ...
                      <div className="space-y-1.5 pr-8">
                        <h3 className="font-serif text-base font-medium text-brand-black">{pillar.title}</h3>
                        <p className="text-brand-charcoal-light text-xs font-sans font-light leading-relaxed">{pillar.description}</p>
                      </div>
                    </div>
                  </div>
                );
      ...
      <section ref={timelineSectionRef} className="bg-brand-beige py-10 sm:py-14 lg:py-16 border-t border-brand-gold/15">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 xl:px-16">
          ...
          <div className="relative">
            ...
            <div ref={timelineGridRef} className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
              {milestones.map((item) => (
                <div key={item.year} className="timeline-reveal pt-6 md:pt-0 relative">
                  ...
                  <span className="font-serif text-2xl sm:text-3xl font-light text-brand-gold mb-2 mt-4 block">{item.year}</span>
                  <h3 className="font-serif text-sm font-semibold text-brand-black mb-1.5">{item.title}</h3>
                  <p className="text-brand-charcoal-light text-xs font-sans font-light leading-relaxed">{item.description}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      >
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          {/* Right – text */}
          <div ref={storyTextRef} className="lg:col-span-5 flex flex-col justify-center space-y-4">
            ...
            <h2 className="story-reveal font-serif text-xl sm:text-2xl lg:text-3xl font-light text-brand-black leading-tight">
              Every Property Deserves <span className="text-brand-gold italic font-serif">Exceptional Stewardship</span>
            </h2>
